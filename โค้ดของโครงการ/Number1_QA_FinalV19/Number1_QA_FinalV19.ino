...
#define DEVICE_ID "Number 1"
#define DEVICE_NUMBER 1

// =====================================================
// STATUS LED - CHILD
// Green LED is wired directly to the 5V power rail (not GPIO).
// Red LED = GPIO 25 (Active LOW) and is controlled by the ESP32.
//
// Green ON      : power is present (including Deep Sleep)
// Red slow blink: searching for Mother
// Red OFF       : normal / connected / collecting data / Deep Sleep
// Red fast blink: communication/send failure
// =====================================================
#define LED_RED 25
...
// Project QA: ต้องมีอย่างน้อยครึ่งหนึ่งของรอบตัวอย่างโดยประมาณ
// ก่อนยอมรับค่าเฉลี่ยของตัวแปรนั้นในรอบ 1 นาที
...
// ระบบหา Channel 1-13 จำนวนสูงสุด 10 รอบ
// =====================================================
...
void setup(){
  ...
  // เปิดเครื่องแล้วกำลังเตรียมระบบ = แดงติดชั่วครู่
  redOn();
  ...
  Serial.println(
    " ESP32 NUMBER 1 - 1 MIN AVERAGE VERSION"
  );
  ...
  // Discovery finished successfully. RED must be OFF.
  redOff();
  delay(50);
  ...
  // เชื่อมต่อสำเร็จและกำลังเก็บข้อมูล = แดงดับ (เขียว Power ติดตลอด)
  showConnected();
  readSensors();
