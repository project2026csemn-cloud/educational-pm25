...
void setup() {
  ...
  // ไม่ว่าจะส่ง Sleep Status สำเร็จหรือไม่
  // ลูกต้องเข้า Deep Sleep จริง
  goToDeepSleep();
}
