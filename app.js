...
groupedChartShell("PM2.5","เปรียบเทียบ 3 จุด","forecastPm25",compareLegend)+
groupedChartShell("PM10","เปรียบเทียบ 3 จุด","forecastPm10",compareLegend)+
groupedChartShell("อุณหภูมิ","เปรียบเทียบ 3 จุด • °C","forecastTemp",compareLegend)+
groupedChartShell("ความชื้น","เปรียบเทียบ 3 จุด • %","forecastHumidity",compareLegend)+
groupedChartShell("แสง","เปรียบเทียบ 3 จุด • lux","forecastLight",compareLegend)+
`</div>`;
